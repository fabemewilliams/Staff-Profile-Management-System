										...
										<div class="form-group col-md-12">
											<div class="form-group">
												...
												<div class="compose-message">
													 <textarea class="form-control" name="biography" id="word_count" rows="12" data-toggle = "tooltip"  title = "Limit Biography to 200 words to avoid truncation" required='required'> </textarea>
