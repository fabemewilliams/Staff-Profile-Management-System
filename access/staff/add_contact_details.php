<?php	
		...
		if (isset($_POST['add_contact_details'])) $notification = $tuwo->add_contact_details($sess_id);
				...
				<div class="col-md-6 col-md-offset-3">
					<div class="panel panel-white">
						...
						<div class="panel-body">
							...
							<div class="col-md-12">
								<div class="row">
									<form name = "add_contact_details" method="POST" >
										<div class="form-group col-md-12">
											<div class="form-group">
												<label>Phone Number</label>
												<input type='tel' name='phone_number' class = 'form-control' pattern="[0-9]{11}" placeholder='Enter Phone Number'	required='required'>
											</div>
										</div>
										<div class="form-group col-md-12">
											<div class="form-group">
												<label>Institutional Email Address</label>
												<input type='email' name='funai_email' class = 'form-control' placeholder='Enter Institutional Email Address'	required='required'>
											</div>
										</div>
										<div class="form-group col-md-12">
											<div class="form-group">
												<label>Alternate Email Address</label>
												<input type='email' name='alternate_email' class = 'form-control' placeholder='Enter Alternate Email Address'	required='required'>
											</div>
										</div>
										...
										<div class="form-group col-md-12">
											<div class="form-group">
												...
												<input type = "hidden" name = "add_contact_details">
											</div>
										</div>
									</form>
								</div>
